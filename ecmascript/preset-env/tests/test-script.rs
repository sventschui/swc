...
fn exec(c: PresetConfig, dir: PathBuf) -> Result<(), Error> {
    ...
    Tester::new()
        .print_errors(|cm, handler| {
            ...
            let actual = script.fold_with(&mut pass);
            ...
            if let Ok(..) = env::var("UPDATE") {
                NormalizedOutput::from(actual_src.clone())
                    .compare_to_file(dir.join("output.cjs"))
                    .unwrap();
            }
...
#[testing::fixture("tests/fixtures/**/input.cjs")]
